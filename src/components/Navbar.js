                ...
                <div className="container-fluid">
                    ...
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu">
                            <li><a className="dropdown-item" onClick={(e) => {e.preventDefault(); handleCountrySelect('PK')}}>PK</a></li>
                            <li><a className="dropdown-item" onClick={(e) => {e.preventDefault(); handleCountrySelect('IN')}}>IN</a></li>
                            <li><a className="dropdown-item" onClick={(e) => {e.preventDefault(); handleCountrySelect('USA')}}>USA</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
